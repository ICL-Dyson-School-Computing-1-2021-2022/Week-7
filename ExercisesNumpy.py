...
# return an array with 8 items that can be any number 
# i.e. doesn't matter what you fill it with, it's
# the size that is important
def create_array8():
    return

# return a 6 x 4 array filled with any number 
# i.e. doesn't matter what you fill it with, it's
# the size that is important
def create_array6_4():
    return

# return a 2x3 array of zeros 
...
# create a function that will return an array that contains 
# the number of values passed in as an input argument evenly 
# spaced from 0 to 2*pi
# hint: you can generate it algorithmically with a numpy function
def algo_array2():
    return 

# create a function with one input argument which takes an input 
# value of a postive number and returns a dictionary with the 
